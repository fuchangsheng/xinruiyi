<?php
// +----------------------------------------------------------------------
// | LQBCMS [ WE CAN DO IT JUST THINK IT ]
// +----------------------------------------------------------------------
// | Copyright (c) 2013 http://www.liqingbo.cn All rights reserved.
// +----------------------------------------------------------------------
// | Author: 码农 <252588119@qq.com> <http://www.liqingbo.cn>
// +----------------------------------------------------------------------
...
class DatabaseController extends CommonController{
    ...
    public function backup(){
        ...
        $filename=date("YmdHis").rand(1000,9999).".sql";
        // 所保存的文件名
        $tmpFile =$backup_path.$filename;
       /* echo "mysqldump -u$cfg_dbuser -p$cfg_dbpwd $cfg_dbname > ".$tmpFile;
        exit;*/
       ...
       /* header("Content-disposition:filename=".$filename);
        ...
        // 用MySQLDump命令导出数据库
        exec("mysqldump -u $cfg_dbuser -p $cfg_dbpwd  $cfg_dbname > ".$tmpFile);
