...
// 		'DEFAULT_GROUP'=>'Home', //默认分组
		...
		//加载其他配置文件　
		'LOAD_EXT_CONFIG' => 'config_debug,config_db,config_url,config_pctime,config_mbtime,config_theme,config_setting,config_base,config_email',//加载扩展配置文件
		'LOAD_EXT_FILE' => 'common,array,url',
